...
const sauceLabsCapabilities = {
	name: '@brightspace-ui-labs/input-duration unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-ui-labs/input-duration ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
